<?php include("header.php"); echo @$msg; ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row gy-4 mt-4">
          ...
          <div class="col-lg-4">
            ...
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Location:</h4>
                <p>Railway Station Road, Bhavnagar, Gujarat 364002</p>
              </div>
            </div><!-- End Info Item -->
            ...
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Email:</h4>
                <p>contact@quicktransport.com</p>
              </div>
            </div><!-- End Info Item -->
          ...
          <div class="col-lg-8">
            <form action="contactus.php" method="post" class="php-email-form">
              ...
              <div class="col-md-6 form-group mt-3">
                <input type="text" class="form-control" name="pno" id="subject" placeholder="Phone Number" required>
              </div>
