<?php 
	include("header.php");
	$table=mysqli_query($conn,"select * from truck where hire='Hired'");
?>
<br/><br/><br/>
<script>
  function showHint(str) 
  {
    if (str.length == 0) {
      ...
      xmlhttp.open("GET","htrucksearch.php?truck=" + str, true);
      xmlhttp.send();
    }
  }
</script>
...
<?php 
    while($row=mysqli_fetch_array($table))
    {
        ...
        echo "<td><button class='btn btn-primary'>$row[hire]</button></td>";
